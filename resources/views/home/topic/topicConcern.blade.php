	...
	<div class="huati-content" >
		...
		<div class="huati-neirong">
			...
			<div class="huati-guanzhu">
				<div class="huati-guanzhu-a"><a href="/topicDetails/{{$v->id}}" target="_blank"><img src="{{$v->img}}" style="width:50px;height:50px"></a></div>
				<div class="huati-guanzhu-wenzi">
					<div class="huati-guanzhu-b"><span><a href="/topicDetails/{{$v->id}}" target="_blank">{{$v->tag_name}}</a></span></div>
