  ...
  <div class="huati-topic">
            ...
            <div class="tab-content">               
                 @foreach($res as $value)
                  <div class="huati-neirong">
                        ...
                        <a href="" class="huati-content-c topicname">{{$value->name}}</a>&nbsp;&nbsp;
      ...
      <div class="huati-guangchang">
          <div class="guangchang-title">
            <button type="button" class="btn btn-success">关注话题</button>&nbsp;&nbsp;
            <a href="">666</a><span>人关注了该话题</span>
            <div class="guangchang-guanli">
            <a href="">组织</a>&nbsp;&nbsp;·&nbsp;&nbsp;<a href="">管理</a>&nbsp;&nbsp;·&nbsp;&nbsp;<a href="">日志</a>
            </div>
          </div>
          ...
          <div class="gunagchang-miaoshu">
            <br><h4>描述</h4><br>
            <span>游戏</span><br>
            <p>{{$description}}&nbsp;&nbsp;&nbsp;<a href="" class="xiugai">修改</a></p>
          </div>
          <!-- 父话题 -->
          <div class="fahuati">
          ...
          <div class="zihuati-title"><span>子话题</span></div>
            ...
            <div class="zihuati-lianjie"><a href="">共有66个子话题,查看话题结构</a></div>
          </div>
      </div>
  </div>
@stop
