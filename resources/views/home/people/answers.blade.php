...
<div role="tabpanel" class="tab-pane" id="huida">
	...
	<div class="dongtai-content">
		...
		<div class="dongtai-content-info col-md-12">
			<div class="dongtai-content-img pull-left"><a target="_blank" href="/people/answer/{{ $val->uid }}"><img style="width:50px;height:50px" src="/uploads/headPic/{{ $val->headpic }}"></a></div>
			<div class="dongtai-content-name">
	    		<div class="col-md-12">
					<a target="_blank" href="/people/answer/{{ $val->uid }}">{{ $val->name }}</a>
	    		</div>
	    		<div class="col-md-12">
