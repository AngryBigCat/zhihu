        ...
        <div class="col-md-8">
            <div id="tuijian" class="">
                ...
                <div class="pull-right">
                    <a href="{{route('found/more')}}">更多推荐<i class="fa fa-angle-double-right"
                    ...
                    <div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading"><a href="">{{$v->name}}，</a><span>{{$v->job}}
                                        ，{{$v->introduction}}</span></h4>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div>
                                                <a href="#" class="pull-left">
                                                    <img class="media-object" src="img/photo3.jpg" alt="..."
                                                         width="200px">
                                                </a>
                                                <span class="pull-right">
                        ...
                        <li class="tan">
                            ...
                            <div class="pull-right">
                                ...
                                <div class="ca">
                                    ...
                                    <div class="pull-right" data-toggle="tooltip" data-placement="bottom"
                                         title="29人觉得这个很赞">29 赞
                                    </div>
                                </div>
                            </div>
                        </li>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                                                                  data-toggle="tab">今日最热</a></li>
                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">本月最热</a>
                        </li>
                    </ul>
        ...
        <div class="col-md-4 right">
            ...
            <div>
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading "><span class="pull-left">热门圆桌</span><a href="#" class="pull-right">更多圆桌<i
                    ...
                    <ul class="list-group clearfix">
                        <li class="list-group-item ff">
                            ...
                            <p id="ss"><a href="#"><span> 422</span>人关注 </a><span> . </span><a href="#"><span> 18</span>个问题
                                </a></p>
                        </li>
                        <li class="list-group-item ff">
                            <img src="/img/avatar.png" alt="" width="40px">
                ...
                <div class="panel panel-default">
                    <!-- Default panel contents -->
                    <div class="panel-heading"><span class="pull-left">热门话题</span><a href="#" class="pull-right">更多话题<i
                                    class="fa fa-angle-double-right" aria-hidden="true"></i></a></div>
                    <!-- List group -->
                    <ul class="list-group clearfix">
                ...
                <div class="panel panel-default">
                    <!-- Default panel contents -->
                    <div class="panel-heading"><span class="pull-left">热门收藏</span><a href="#" class="pull-right">换一批<i
                                    class="fa fa-repeat" aria-hidden="true"></i></a></div>
                    <!-- List group -->
