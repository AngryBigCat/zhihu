            ...
            <div class="eamil-left">
                <div data-type="inboxmsg" class="eamil-right">
                    <div>
                        ...
                        <label class="col-md-offset-1"> <input type="radio" name="inboxmsg-receive" value="all"
                                                               checked=""/> 允许所有人给我发私信 </label>
                        <label class="col-md-offset-1"> <input type="radio" name="inboxmsg-receive" value="follow"/>
                            只允许我关注的人给我发私信 </label>
                    </div>
                    <br>
