...
<div role="tabpanel" class="tab-pane active" id="dongtai">
    	...
    	<div class="dongtai-content">
	    	...
	    	<div class="dongtai-content-info col-md-12">
	    		...
	    		<div class="dongtai-content-name col-md-10">
		    		<div class="col-md-12">
						<a href="">闻佳</a>
		    		</div>
		    		<div class="col-md-12">
	    	...
	    	<div class="dongtai-content-gongneng">
					...
					<button class="dongtai-content-link"><span>666 </span>条评论</button>
					<button class="dongtai-content-link">分享</button>
					<button class="dongtai-content-link">收藏</button>
					<button class="dongtai-content-link">感谢</button>
	    	</div>
    	</div>
    	<hr/>
    	<div class="dongtai-content">
